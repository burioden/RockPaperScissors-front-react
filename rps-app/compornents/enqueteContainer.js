...
export function EnqueteContainer(props) {
  ...
  const examples = [
    { gender: "男性", age: "20代", principle: "お互いに干渉しすぎない" },
    { gender: "女性", age: "20代", principle: "好意を定期的に伝える" },
    {
      gender: "ノンバイナリー",
      age: "30代",
      principle: "感じたことを言語化して伝える",
    },
    { gender: "男性", age: "20代", principle: "あいさつをする" },
    { gender: "女性", age: "30代", principle: "自分の時間を大切にする" },
    { gender: "男性", age: "20代", principle: "自分の言葉に責任を持つ" },
  ];
